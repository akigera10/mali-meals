          ...
          {links.map(link => (
            <Link
              ...
              style={{
                ...
                color: isActive(link.href) ? 'var(--brand-gold)' : 'var(--text-secondary)',
                borderBottom: isActive(link.href) ? '2px solid var(--brand-gold)' : '2px solid transparent',
                textDecoration: 'none',
        ...
        {moreLinks.map(link => (
          <Link
            ...
            style={{
              ...
              fontSize: '15px',
              fontFamily: 'var(--font-inter)',
              color: isActive(link.href) ? 'var(--brand-gold)' : 'var(--text-primary)',
              backgroundColor: isActive(link.href) ? 'var(--brand-gold-soft)' : 'transparent',
              textDecoration: 'none',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '4px' }}>
          ...
          <button
            ...
            style={{
              ...
              fontSize: '12px',
              fontFamily: 'var(--font-inter)',
              color: moreOpen || moreIsActive ? 'var(--brand-gold)' : 'var(--text-secondary)',
              backgroundColor: moreOpen || moreIsActive ? 'var(--brand-gold-soft)' : 'transparent',
              border: 'none',
